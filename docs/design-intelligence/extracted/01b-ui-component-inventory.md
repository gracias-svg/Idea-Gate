...
Together, these documents inform Grammar/Constitution amendments via the Exception Protocol (Grammar §13). They are reference material, not construction authority — Grammar §12/CLAUDE.md remain sole authority on what is built.